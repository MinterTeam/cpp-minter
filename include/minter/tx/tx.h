...
public:
    ...
    dev::bytes_data sign_external(const minter::signature& sign);

    /// \brief Make transaction from external signature
    /// \param sign external signature
    /// \return rlp encoded transaction data with signature info
    dev::bytes_data sign_external(minter::signature&& sign);
    ...
    /// \return rlp encoded transaction data with signature info
    dev::bytes_data sign_external(signer_func_c_t func);
    ...
    /// \return rlp encoded transaction data with signature info
    dev::bytes_data sign_external(signer_func_t func);
    ...
    dev::bytes_data sign_multiple(const minter::data::address& signatureAddress, const std::vector<minter::data::private_key>& pks);
