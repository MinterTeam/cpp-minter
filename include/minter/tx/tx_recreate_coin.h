...
public:
    ...
    /// \param amount bigint
    /// \return
    tx_recreate_coin& set_initial_amount(dev::bigint amount);
    ...
    /// \param amount
    /// \return
    tx_recreate_coin& set_initial_reserve(dev::bigint amount);
    /// \brief
    ...
    tx_recreate_coin& set_max_supply(dev::bigint max_supply);
